...
// escapeXML performs XML entity escaping.
// Performance: Uses a global strings.Replacer to perform all replacements in a single pass,
// which is significantly more efficient than multiple strings.ReplaceAll calls.
